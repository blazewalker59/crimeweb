 ...
 */
export function removeDecision(sourceEpisodeId: number, matchedEpisodeId: number): void {
  if (typeof window === "undefined") return;
 ...
 */
export function isMatchConfirmed(sourceEpisodeId: number, matchedEpisodeId: number): boolean {
 ...
 */
export function isMatchDenied(sourceEpisodeId: number, matchedEpisodeId: number): boolean {
